...
namespace Audiochan.Core.Features.Auth.Refresh
{
    ...
    public class RefreshTokenCommandHandler : IRequestHandler<RefreshTokenCommand, IResult<AuthResultViewModel>>
    {
        ...
        public RefreshTokenCommandHandler(UserManager<User> userManager, ITokenService tokenService, IDateTimeService dateTimeService)
        {
        ...
        public async Task<IResult<AuthResultViewModel>> Handle(RefreshTokenCommand request, CancellationToken cancellationToken)
        {
